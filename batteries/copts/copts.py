"""Batteries compiler options.

This is the source of truth for Batteries compiler options.  To modify Batteries
compilation options:

  (1) Edit the appropriate list in this file based on the platform the flag is
      needed on.
  (2) Run `<path_to_batteries>/copts/generate_copts.py`.

The generated copts are consumed by configure_copts.bzl and
BatteriesConfigureCopts.cmake.
"""
...
LLVM_DISABLE_WARNINGS_FLAGS = [
    # Batteries does not support C++98
...
COPT_VARS = {
    ...
    "BATT_RANDOM_HWAES_ARM64_FLAGS": ["-march=armv8-a+crypto"],
    "BATT_RANDOM_HWAES_ARM32_FLAGS": ["-mfpu=neon"],
    "BATT_RANDOM_HWAES_X64_FLAGS": [
        "-maes",
        "-msse4.1",
    ],
    "BATT_RANDOM_HWAES_MSVC_X64_FLAGS": [],
}
