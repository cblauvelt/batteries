#!/usr/bin/python
"""Generate Batteries compile compile option configs.

Usage: <path_to_batteries>/copts/generate_copts.py
...
def file_header_lines():
  return [
      ...
      "(1) Edit batteries/copts/copts.py.",
      "(2) Run `python <path_to_batteries>/copts/generate_copts.py`."
  ]
...
class CMakeStyle(object):
  ...
  def filename(self):
    return "GENERATED_BatteriesCopts.cmake"
