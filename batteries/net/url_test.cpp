...
class MultipleShouldEscapeTests
    : public ::testing::TestWithParam<ShouldEscapeTest> {};
...
INSTANTIATE_TEST_SUITE_P(
    ShouldEscapeTest, MultipleShouldEscapeTests,
    ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        EscapeTest{"", "", batteries::net::UrlNoError},
        EscapeTest{"abc", "abc", batteries::net::UrlNoError},
        EscapeTest{"1%41", "1A", batteries::net::UrlNoError},
        EscapeTest{"1%41%42%43", "1ABC", batteries::net::UrlNoError},
        EscapeTest{"%4a", "J", batteries::net::UrlNoError},
        EscapeTest{"%6F", "o", batteries::net::UrlNoError},
        EscapeTest{"%", "", batteries::net::UrlRangeError("%")},
        EscapeTest{"%a", "", batteries::net::UrlRangeError("%a")},
        EscapeTest{"%1", "", batteries::net::UrlRangeError("%1")},
        EscapeTest{"123%45%6", "", batteries::net::UrlRangeError("123%45%6")},
        EscapeTest{"%zzzzz", "", batteries::net::UrlEscapeError("%zz")},
        EscapeTest{"a+b", "a b", batteries::net::UrlNoError},
        EscapeTest{"a%20b", "a b", batteries::net::UrlNoError}));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        EscapeTest{"", "", batteries::net::UrlNoError},
        EscapeTest{"abc", "abc", batteries::net::UrlNoError},
        EscapeTest{"one two", "one+two", batteries::net::UrlNoError},
        EscapeTest{"10%", "10%25", batteries::net::UrlNoError},
        EscapeTest{" ?&=#+%!<>#\"{}|\\^[]`☺\t:/@$'()*,;",
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        EscapeTest{"", "", batteries::net::UrlNoError},
        EscapeTest{"abc", "abc", batteries::net::UrlNoError},
        EscapeTest{"abc+def", "abc+def", batteries::net::UrlNoError},
        EscapeTest{"a/b", "a%2Fb", batteries::net::UrlNoError},
        EscapeTest{"one two", "one%20two", batteries::net::UrlNoError},
        EscapeTest{"10%", "10%25", batteries::net::UrlNoError},
        EscapeTest{" ?&=#+%!<>#\"{}|\\^[]`☺\t:/@$'()*,;",
...
TEST_P(MultipleParseHostTests, ParseHostTest) {
    ...
    std::tie(host, port, err) =
        batteries::net::internal::parseHost(GetParam().in);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        ParseHostTest{"[::1]:", "[::1]", "", batteries::net::UrlNoError},
        ParseHostTest{"[fe80::1%25en0]", "[fe80::1%en0]", "",
                      batteries::net::UrlNoError},
        ...
        ParseHostTest{"[fe80::1%25%65%6e%301-._~]:8080", "[fe80::1%en01-._~]",
                      "8080", batteries::net::UrlNoError},
        ParseHostTest{"localhost", "localhost", "", batteries::net::UrlNoError},
        ParseHostTest{"localhost:443", "localhost", "443",
                      batteries::net::UrlNoError},
...
TEST_P(MultipleParseAuthorityTests, ParseAuthorityTests) {
    ...
    std::tie(username, password, host, err) =
        batteries::net::internal::parseAuthority(GetParam().in);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ParseAuthorityTest{"user:password@foo.com:80", "user", "password",
                           "foo.com:80", batteries::net::UrlNoError},
        ParseAuthorityTest{"foo.com:80", "", "", "foo.com:80",
                           batteries::net::UrlNoError},
        ParseAuthorityTest{// malformed host should not cause error
                           "user@password:foo.com:80", "user", "",
                           "password:foo.com:80", batteries::net::UrlNoError},
        ParseAuthorityTest{"us^er:password@foo.com:80", "", "", "",
...
TEST_P(MultipleParseSchemeTests, ParseSchemeTests) {
    ...
    std::tie(scheme, rest, err) =
        batteries::net::internal::parseScheme(GetParam().in);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ParseSchemeTest{"http://root:password@192.168.1.1:8080/path/to/file",
                        ...
                        batteries::net::UrlNoError},
        ParseSchemeTest{"file://test.txt", "file", "//test.txt",
                        batteries::net::UrlNoError}));
...
std::ostream& operator<<(std::ostream& os, const ParseUrlTest& pt) {
    return os << "in: " << pt.in << ", scheme: " << pt.scheme
              ...
              << ", path: " << pt.path << ", rawPath: " << pt.rawPath
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        ParseUrlTest{"http://foo.com/path?a=1&b=2", "http", "", "", "",
                     ...
                     batteries::net::Query(batteries::net::QueryValues{
                         {"a", "1"}, {"b", "2"}}),
                     "", batteries::net::UrlNoError},
        ParseUrlTest{
            "/",                       // in
